...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a]  selection:bg-white/20">
      <section className="relative flex flex-col  h-screen items-center overflow-hidden px-4 pb-24 pt-40 text-center">
        <HoleBackground
          ...
          style={{
            ...
            WebkitMaskImage:
              "linear-gradient(to bottom ,rgba(0,0,0,0.6) 0%,rgba(0,0,0.5) 50%,trasparent 100% ",
          }}
        />
        ...
        <div className=" relative mx-auto mt-12 w-full max-w-2xl">
          ...
          >
            <textarea
              ...
              rows={1}
              className="w-full resize-none bg-transparent px-5 pb-4 pt-5 text-sm placeholder:text-white/20  foucs:outline-none sm:text-base"
              style={{ minHeight: 56, maxHeight: 200 }}
              placeholder={PLACEHOLDERS[placeholerIndex]}
            />
          ...
          <div
            className="mt-4
 flex flex-wrap justify-self-center gap-2"
          >
            {SUGGESTIONS.map((s) => (
              <button
                key={s}
        ...
        <p className="mt-10 text-xs text-white/40">
          No credit card required .10 free gererations on sign up
        </p>
      </section>
      ...
      "
        >
          <SectionLabel>Simple Price</SectionLabel>
          <SectionHeading gray="Staart free" blue="Scale when ready" />

          <p className="mx-auto mt-4 max-w-sm text-sm text-white/35 ">
            No Credit card requrired .Upgrade or downgrade anytime
          </p>
        </div>
      ...
      <section className="relative mx-auto mb-32  max-w-5l overflow-hidden rounded-2xl border-white/8 px-10 py-24 text-center">
        ...
        <p className="mb-8 text-sm leading leading-relaxed text-white/40 ">
          Get 10 free genrations on sign up. No credit card required
        </p>
        <br />
